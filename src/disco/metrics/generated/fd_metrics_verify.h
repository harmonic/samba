...
#define FD_METRICS_COUNTER_VERIFY_TRANSACTION_BLOCK_PEER_FAILURE_OFF  (17UL)
#define FD_METRICS_COUNTER_VERIFY_TRANSACTION_BLOCK_PEER_FAILURE_NAME "verify_transaction_block_peer_failure"
#define FD_METRICS_COUNTER_VERIFY_TRANSACTION_BLOCK_PEER_FAILURE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_VERIFY_TRANSACTION_BLOCK_PEER_FAILURE_DESC "Count of transactions that failed to verify because a peer transaction in the block failed"
#define FD_METRICS_COUNTER_VERIFY_TRANSACTION_BLOCK_PEER_FAILURE_CVT  (FD_METRICS_CONVERTER_NONE)
