...
enum {
  ...
  FD_METRICS_COUNTER_PACK_TRANSACTION_INSERTED_BLOCK_FAILED_OFF = FD_METRICS_COUNTER_PACK_TRANSACTION_INSERTED_OFF,
  FD_METRICS_COUNTER_PACK_TRANSACTION_INSERTED_INSTR_ACCT_CNT_OFF,
...
#define FD_METRICS_COUNTER_PACK_TRANSACTION_INSERTED_CNT  (24UL)
