...
#define FD_METRICS_GAUGE_BUNDLE_TPU_CONNECTED_OFF  (29UL)
#define FD_METRICS_GAUGE_BUNDLE_TPU_CONNECTED_NAME "bundle_tpu_connected"
#define FD_METRICS_GAUGE_BUNDLE_TPU_CONNECTED_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_BUNDLE_TPU_CONNECTED_DESC "1 if connected to the TPU endpoint, 0 if not"
#define FD_METRICS_GAUGE_BUNDLE_TPU_CONNECTED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_BUNDLE_TPU_PACKET_RECEIVED_OFF  (30UL)
#define FD_METRICS_COUNTER_BUNDLE_TPU_PACKET_RECEIVED_NAME "bundle_tpu_packet_received"
#define FD_METRICS_COUNTER_BUNDLE_TPU_PACKET_RECEIVED_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_BUNDLE_TPU_PACKET_RECEIVED_DESC "Total count of packets received from TPU endpoint"
#define FD_METRICS_COUNTER_BUNDLE_TPU_PACKET_RECEIVED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_BUNDLE_TPU_TRANSACTION_RECEIVED_OFF  (31UL)
#define FD_METRICS_COUNTER_BUNDLE_TPU_TRANSACTION_RECEIVED_NAME "bundle_tpu_transaction_received"
#define FD_METRICS_COUNTER_BUNDLE_TPU_TRANSACTION_RECEIVED_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_BUNDLE_TPU_TRANSACTION_RECEIVED_DESC "Total count of transactions received from TPU endpoint"
#define FD_METRICS_COUNTER_BUNDLE_TPU_TRANSACTION_RECEIVED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_BUNDLE_BLOCK_RECEIVED_OFF  (32UL)
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_RECEIVED_NAME "bundle_block_received"
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_RECEIVED_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_RECEIVED_DESC "Total count of blocks received"
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_RECEIVED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_BUNDLE_BLOCK_TRANSACTION_RECEIVED_OFF  (33UL)
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_TRANSACTION_RECEIVED_NAME "bundle_block_transaction_received"
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_TRANSACTION_RECEIVED_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_TRANSACTION_RECEIVED_DESC "Total count of transactions received from blocks"
#define FD_METRICS_COUNTER_BUNDLE_BLOCK_TRANSACTION_RECEIVED_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_BUNDLE_RTT_SAMPLE_OFF  (34UL)
...
#define FD_METRICS_GAUGE_BUNDLE_RTT_SMOOTHED_OFF  (35UL)
...
#define FD_METRICS_GAUGE_BUNDLE_RTT_VAR_OFF  (36UL)
...
#define FD_METRICS_HISTOGRAM_BUNDLE_MESSAGE_RX_DELAY_NANOS_OFF  (37UL)
...
#define FD_METRICS_BUNDLE_TOTAL (22UL)
