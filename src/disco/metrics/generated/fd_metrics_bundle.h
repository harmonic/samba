...
enum {
  ...
  FD_METRICS_GAUGE_BUNDLE_TPU_CONNECTED_OFF,
  FD_METRICS_COUNTER_BUNDLE_TPU_PACKET_RECEIVED_OFF,
  FD_METRICS_COUNTER_BUNDLE_TPU_TRANSACTION_RECEIVED_OFF,
  FD_METRICS_COUNTER_BUNDLE_BLOCK_RECEIVED_OFF,
  FD_METRICS_COUNTER_BUNDLE_BLOCK_TRANSACTION_RECEIVED_OFF,
...
#define FD_METRICS_BUNDLE_TOTAL (25UL)
